...
header{padding:18px 22px;background:#07110c;border-bottom:1px solid rgba(0,255,106,.25);display:flex;justify-content:space-between;gap:12px;align-items:center}
h1{margin:0;color:#00ff6a;font-size:22px}
main{padding:18px;max-width:1180px;margin:0 auto;display:grid;gap:14px}
.card{background:rgba(10,15,25,.96);border:1px solid rgba(0,255,106,.25);border-radius:16px;padding:16px}
.row{display:grid;grid-template-columns:160px 1fr 1fr 1fr 110px;gap:8px;align-items:center;margin-bottom:8px}
...
<header>
  <div>
    ...
    <div class="muted">Página leve só para editar horários da grade</div>
  </div>
