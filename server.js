...
<script>
  ...
  diasBtns.forEach(function(dia) {
    ...
    diasDiv.appendChild(b);var b2=document.createElement("a");b2.href="/admin/sorteio-central/vagas?adminSecret="+prompt("Senha admin para Vagas:","");b2.innerHTML="&#128227; Vagas Abertas";b2.style="position:fixed;top:12px;right:220px;background:#1a5a3a;color:#fff;padding:8px 14px;border-radius:8px;text-decoration:none;font-weight:800;font-size:13px;z-index:9999;";document.body.appendChild(b2);
  });
